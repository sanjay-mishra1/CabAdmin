...
public class EditDriverActivity extends AppCompatActivity {
    ...
    int month30[]={ 4 , 6 , 9 , 11 };
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            Button action_bt=findViewById(R.id.action_button);
            action_bt.setText("Store Changes");
            extractDriverDetails();
        }

    private void extractDriverDetails() {
        HashMap<String,Object> details= new Store().extractDriverDetails();
        edit_driverName.setText((String)details.get("Name"));
        edit_dob.setText((String)details.get("DOB"));
       try {
           if (Objects.requireNonNull(details.get("Gender")).equals("Male")) {
               gender_male.setChecked(true);
           } else gender_female.setChecked(true);
       }catch (Exception ignored){}
        car_name.setText((String)details.get("CarName"));
        car_number.setText((String)details.get("CarNumber"));
